...
Contents of the .zip file includes the following:

* test/X_test.txt - Test data 
* test/y_test.txt - Test column labels
* train/X_train.txt - Training data 
* train/y_train.txt - Training column labels
...
## Transformation required in run_analysis.R script
